...
type DoubleActionProps = {
  onClick: React.MouseEventHandler<SVGSVGElement>
  disabled: boolean
}

export const DoubleAction = ({ onClick, disabled }: DoubleActionProps) => {
  return <DoubleActionIcon onClick={onClick} disabled={disabled} />
}

interface DoubleActionIconProps extends React.SVGProps<SVGSVGElement> {
  onClick: React.MouseEventHandler<SVGSVGElement>
  disabled: boolean
}

export const DoubleActionIcon = (props: DoubleActionIconProps) => {
  return (
    <svg
      className="ui-stroke-cyan-500"
      width="2.4em"
      height="2.4em"
      viewBox="0 0 39 24"
      fill="none"
